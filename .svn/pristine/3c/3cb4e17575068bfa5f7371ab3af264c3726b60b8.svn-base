jQuery(document).ready(function(){
		...
		///// SIMPLE CHART /////
		var perijinan = [[0, 20], [1, 20], [2,34], [3, 25], [4, 50], [5, 13], [6, 21]];
		var pelanggaran = [[0, 17], [1, 33], [2,12], [3, 23], [4, 17], [5, 13], [6, 33]];
		...
		var plot = jQuery.plot(jQuery("#chartplace"),
			   [ { data: perijinan, label: "Perijinan(x)", color: "#069"}, { data: pelanggaran, label: "Pelanggaran(x)", color: "#FF2121"} ], {
				   series: {
