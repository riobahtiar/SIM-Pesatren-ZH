...
--
-- Host: 127.0.0.1
-- Generation Time: 06 Agu 2014 pada 18.41
-- Versi Server: 5.6.16
-- PHP Version: 5.5.9
...
CREATE TABLE IF NOT EXISTS `daftar_pelanggaran` (
  ...
  `nama_pelanggaran` varchar(30) DEFAULT NULL,
  `deskripsi` varchar(160) DEFAULT NULL,
  `hukuman` varchar(160) DEFAULT NULL,
  `point_pelanggaran` varchar(3) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `detail_pelanggaran` (
  `id_detail_p` int(5) NOT NULL AUTO_INCREMENT,
  `id_santri` int(8) DEFAULT NULL,
  `id_pelanggaran` int(3) DEFAULT NULL,
  `id_petugas` int(8) DEFAULT NULL,
  `saksi` varchar(30) DEFAULT NULL,
  `tempat_pelanggaran` varchar(30) DEFAULT NULL,
  `waktu_pelanggaran` date DEFAULT NULL,
  `keterangan` text,
  `sanksi` varchar(160) DEFAULT NULL,
  PRIMARY KEY (`id_detail_p`),
  KEY `FK_santri` (`id_santri`),
  KEY `FK_pelanggaran` (`id_pelanggaran`),
...
INSERT INTO `halaman` (`id_halaman`, `judul_halaman`, `isi_halaman`, `url`, `id_user`) VALUES
(1, 'Tentang Website', 'Masih Dalam Pengembangan', '{site root}/home/tentang-websi', 20140001),
(2, 'Hubungi Kami', 'Masih Dalam Pengembangan', '{site root}/home/hubungi-kami', 20140001),
(3, 'Petunjuk Pendaftaran', 'Masih Dalam Pengembangan', '{site root}/home/petunjuk-pend', 20140001),
(4, 'Wali Santri', 'Masih Dalam Pengembangan', '{site root}/home/wali-santri', 20140001),
(5, 'Daftar Sukses', 'Masih Dalam Pengembangan', '{site root}/home/daftar-sukses', 20140001);
...
CREATE TABLE IF NOT EXISTS `kabupaten` (
  `id_kabupaten` varchar(20) NOT NULL DEFAULT '',
  `id_propinsi` varchar(20) NOT NULL DEFAULT '',
  `kabupaten` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id_kabupaten`),
  KEY `FK_propinsi` (`id_propinsi`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('3171', '31', 'KODYA JAKARTA SELATAN'),
('3172', '31', 'KODYA JAKARTA TIMUR'),
('3173', '31', 'KODYA JAKARTA PUSAT'),
('3174', '31', 'KODYA JAKARTA BARAT'),
('3175', '31', 'KODYA JAKARTA UTARA'),
('3201', '32', 'BOGOR'),
('3202', '32', 'SUKABUMI'),
('3203', '32', 'CIANJUR'),
('3204', '32', 'BANDUNG'),
...
INSERT INTO `kategori` (`id_kategori`, `nama_kategori`, `nkat2`) VALUES
(1, 'Wali Santri', NULL),
(2, 'Santri Baru', NULL),
(3, 'Umum', NULL);
...
CREATE TABLE IF NOT EXISTS `kecamatan` (
  `id_kecamatan` varchar(20) NOT NULL DEFAULT '',
  `id_kabupaten` varchar(20) NOT NULL DEFAULT '',
...
('1203102', '1203', 'MUARO BATANG TORU'),
...
('1275210', '1275', 'MEDAN KOTA BELAWAN'),
...
('1303061', '1303', 'TIGO LURAH BAJANJANG'),
...
('1306050', '1306', 'II.X.XI.VI.LINGKUNG'),
('1306051', '1306', 'VI.LINGKUNG'),
('1306052', '1306', '2 X 11 KAYU TANAM'),
('1306060', '1306', 'VII KOTO SUNGAI SARIK'),
...
('1307070', '1307', 'IV ANGKAT CANDUNG'),
...
('1311011', '1311', 'ASAM JUJUHAN'),
('1311012', '1311', 'KOTO BESAR'),
...
('1408050', '1408', 'BANTAN'),
('1408060', '1408', 'MERBAU'),
('1408070', '1408', 'RANGSANG'),
('1408071', '1408', 'RANGSANG BARAT'),
('1408080', '1408', 'TEBING TINGGI'),
('1408081', '1408', 'TEBING TINGGI BARAT'),
...
('1801010', '1801', 'PESISIR SELATAN'),
('1801011', '1801', 'BENGKUNAT'),
('1801012', '1801', 'BENGKUNAT BELIMBING'),
('1801013', '1801', 'NGAMBUR'),
('1801020', '1801', 'PESISIR TENGAH'),
('1801021', '1801', 'KARYA PENGGAWA'),
('1801030', '1801', 'PESISIR UTARA'),
('1801031', '1801', 'LEMONG'),
...
('1812000', '1812', 'TULANG BAWANG BARAT'),
('1812010', '1812', 'TULANG BAWANG UDIK'),
('1812020', '1812', 'TUMIJAJAR'),
...
('2172020', '2172', 'TANJUNG PINANG TIMUR'),
('2172030', '2172', 'TANJUNG PINANG KOTA'),
('2172040', '2172', 'TANJUNG PINANG BARAT'),
...
('3207010', '3207', 'CIMERAK'),
('3207020', '3207', 'CIJULANG'),
('3207030', '3207', 'CIGUGUR'),
('3207040', '3207', 'LANGKAPLANCAR'),
('3207050', '3207', 'PARIGI'),
('3207060', '3207', 'SIDAMULIH'),
('3207070', '3207', 'PANGANDARAN'),
('3207080', '3207', 'KALIPUCANG'),
('3207090', '3207', 'PADAHERANG'),
('3207091', '3207', 'MANGUNJAYA'),
...
('3304020', '3304', 'PURWOREJO KLAMPOK'),
...
('3511031', '3511', 'JAMBERSARI DARUS SHOLAH'),
('3511040', '3511', 'PUJER'),
...
('5313040', '5313', 'SATARMESE'),
('5313041', '5313', 'SATARMESE BARAT'),
...
('6101090', '6101', 'PALOH'),
('6102010', '6102', 'SUNGAIRAYA'),
('6102011', '6102', 'CAPKALA'),
('6102012', '6102', 'SUNGAIRAYA KEPULAUAN'),
...
('6111010', '6111', 'PULAU MAYA KARIMATA'),
...
('6207010', '6207', 'BULIK'),
('6207011', '6207', 'BULIK TIMUR'),
('6207012', '6207', 'MENTHOBI RAYA'),
('6207013', '6207', 'SEMATU JAYA'),
...
('6308000', '6308', 'HULU SUNGAI UTARA'),
...
('6404040', '6404', 'SENGATA UTARA'),
('6404041', '6404', 'BENGALON'),
('6404042', '6404', 'TELUK PANDAN'),
('6404043', '6404', 'SENGATA SELATAN'),
...
('6405110', '6405', 'BIATAN'),
('6406010', '6406', 'KAYAN HULU'),
('6406011', '6406', 'SUNGAI BOH'),
('6406012', '6406', 'KAYAN SELATAN'),
('6406020', '6406', 'KAYAN HILIR'),
('6406030', '6406', 'PUJUNGAN'),
('6406031', '6406', 'BAHAU HULU'),
('6406040', '6406', 'MALINAU KOTA'),
('6406041', '6406', 'MALINAU SELATAN'),
('6406042', '6406', 'MALINAU BARAT'),
('6406043', '6406', 'MALINAU UTARA'),
('6406050', '6406', 'MENTARANG'),
('6406051', '6406', 'MENTARANG HULU'),
('6407010', '6407', 'PESO'),
('6407011', '6407', 'PESO HILIR'),
('6407020', '6407', 'TANJUNG PALAS'),
('6407021', '6407', 'TANJUNG PALAS BARAT'),
('6407022', '6407', 'TANJUNG PALAS UTARA'),
('6407023', '6407', 'TANJUNG PALAS TIMUR'),
('6407024', '6407', 'TANJUNG SELOR'),
('6407025', '6407', 'TANJUNG PALAS TENGAH'),
('6407030', '6407', 'SEKATAK'),
('6407050', '6407', 'BUNYU'),
('6408010', '6408', 'KRAYAN'),
('6408011', '6408', 'KRAYAN SELATAN'),
('6408020', '6408', 'LUMBIS'),
('6408030', '6408', 'SEMBAKUNG'),
('6408040', '6408', 'NUNUKAN'),
('6408041', '6408', 'SEBUKU'),
('6408042', '6408', 'NUNUKAN SELATAN'),
('6408050', '6408', 'SEBATIK'),
('6408051', '6408', 'SEBATIK BARAT'),
('6409010', '6409', 'BABULU'),
('6409020', '6409', 'WARU'),
('6409030', '6409', 'PENAJAM'),
('6409040', '6409', 'SEPAKU'),
('6410010', '6410', 'SESAYAP'),
('6410020', '6410', 'SESAYAP HILIR'),
('6410030', '6410', 'TANA LIA'),
...
('6473010', '6473', 'TARAKAN TIMUR'),
('6473020', '6473', 'TARAKAN TENGAH'),
('6473030', '6473', 'TARAKAN BARAT'),
('6473040', '6473', 'TARAKAN UTARA'),
...
('7308023', '7308', 'LAU'),
('7308030', '7308', 'MAROS UTARA / BONTOA'),
...
('7407040', '7407', 'WANGI-WANGI SELATAN'),
('7407050', '7407', 'WANGI-WANGI'),
...
('7604020', '7604', 'MAMUJU'),
('7604021', '7604', 'SIMBORO DAN KEPULAUAN'),
...
('8171030', '8171', 'TELUK AMBON'),
('8171040', '8171', 'BAGUALA'),
('8171050', '8171', 'LEITIMUR SELATAN'),
('8172010', '8172', 'PP. KUR MANGUR'),
...
('8207030', '8207', 'MOROTAI UTARA'),
('8207040', '8207', 'MOROTAI JAYA'),
('8207050', '8207', 'MOROTAI SELATAN BARAT'),
...
('9106020', '9106', 'KOKODA'),
('9106021', '9106', 'MATEMANI KAIS'),
('9106030', '9106', 'AIFAT TIMUR'),
('9106040', '9106', 'AIFAT'),
('9106050', '9106', 'AITINYO'),
('9106060', '9106', 'MOSWAREN'),
('9106070', '9106', 'TEMINABUAN'),
('9106071', '9106', 'SEREMUK'),
('9106072', '9106', 'WAYER'),
('9106080', '9106', 'SAWIAT'),
('9106090', '9106', 'AYAMARU'),
('9106100', '9106', 'MARE'),
('9106110', '9106', 'AYAMARU UTARA'),
('9107060', '9107', 'MORAID'),
('9107100', '9107', 'MAKBON'),
('9107110', '9107', 'BERAUR'),
...
('9171021', '9171', 'SORONG'),
('9171022', '9171', 'SORONG UTARA'),
('9171023', '9171', 'SORONG MANOI'),
('9401010', '9401', 'KIMAAM'),
('9401011', '9401', 'WAAN'),
('9401012', '9401', 'TABONJI'),
('9401013', '9401', 'ILYAWAB'),
('9401020', '9401', 'OKABA'),
('9401021', '9401', 'TUBANG'),
('9401022', '9401', 'NGGUTI'),
('9401023', '9401', 'KAPTEL'),
...
('9410010', '9410', 'TIGI'),
('9410011', '9410', 'KAPIRAYA'),
('9410012', '9410', 'TIGI BARAT'),
('9410020', '9410', 'TIGI TIMUR'),
...
('9410100', '9410', 'BIANDOGA'),
('9410101', '9410', 'WANDAI'),
('9410110', '9410', 'AGISIGA'),
('9410120', '9410', 'BOWOBADO'),
('9411040', '9411', 'FAWI'),
('9411050', '9411', 'MULIA'),
...
('9412021', '9412', 'MIMIKA TIMUR TENGAH'),
...
CREATE TABLE IF NOT EXISTS `konfirmasi_bayar` (
  ...
  `id_santri_baru` int(8) DEFAULT NULL,
  `nama_santri` varchar(30) DEFAULT NULL,
  `bank_santri` varchar(50) DEFAULT NULL,
  `no_rekening` varchar(50) DEFAULT NULL,
  `waktu_transfer` date DEFAULT NULL,
  `nominal_transfer` varchar(12) DEFAULT NULL,
  `catatan_lain` text,
  `kontak` varchar(12) DEFAULT NULL,
  `status` enum('Lunas','Belum Lunas') DEFAULT NULL,
  `id_user` int(8) DEFAULT NULL,
  PRIMARY KEY (`id_konfirmasi`),
  KEY `fk_sb_konfirmasi` (`id_santri_baru`),
  KEY `fk_user_konfirmasi` (`id_user`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Struktur dari tabel `lembaga_pendidikan`
--

CREATE TABLE IF NOT EXISTS `lembaga_pendidikan` (
  `id_pendidikan` int(3) NOT NULL AUTO_INCREMENT,
  `nama` varchar(50) DEFAULT NULL,
  `kontak` varchar(30) DEFAULT NULL,
  `tingkat` enum('Sekolah','Universitas','Pondok','Pendidikan Non-Formal') DEFAULT NULL,
  `email` varchar(30) DEFAULT NULL,
  `website` varchar(30) DEFAULT NULL,
  `id_priode` int(4) DEFAULT NULL,
  PRIMARY KEY (`id_pendidikan`),
  KEY `FK_priode` (`id_priode`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=21 ;

--
-- Dumping data untuk tabel `lembaga_pendidikan`
--

INSERT INTO `lembaga_pendidikan` (`id_pendidikan`, `nama`, `kontak`, `tingkat`, `email`, `website`, `id_priode`) VALUES
(1, 'TK Zainul Hasan 1', NULL, 'Sekolah', NULL, 'http://sdzaha.com', NULL),
(2, 'Pondok Zainul Hasanain', NULL, 'Pondok', NULL, 'http://sdzaha.com', NULL),
(3, 'Pondok Barokatul Hasanain', NULL, 'Pondok', NULL, 'http://xyz.com', NULL),
(4, 'Pondok Darut Tauhid', NULL, 'Pondok', NULL, 'http://xyz.com', NULL),
(5, 'Pondok Putra Damanhuri Romly', NULL, 'Pondok', NULL, 'http://xyz.com', NULL),
(6, 'Pondok Hafshawaty Genggong', NULL, 'Pondok', NULL, 'http://xyz.com', NULL),
(7, 'SD Zainul Hasan Genggong', NULL, 'Sekolah', NULL, 'http://xyz.com', NULL),
(8, 'MI Zainul Hasan Genggong', NULL, 'Sekolah', NULL, 'http://xyz.com', NULL),
(9, 'SMP Zainul Hasan Genggong', NULL, 'Sekolah', NULL, 'http://xyz.com', NULL),
(10, 'MTS Zainul Hasan Genggong', NULL, 'Sekolah', NULL, 'http://xyz.com', NULL),
(11, 'SMA Zainul Hasan Genggong', NULL, 'Sekolah', NULL, 'http://xyz.com', NULL),
(12, 'SMK Zainul Hasan Genggong', NULL, 'Sekolah', NULL, 'http://x.co', NULL),
(13, 'MA Zainul Hasan Genggong', NULL, 'Sekolah', NULL, 'http://ver.com', NULL),
(14, 'SMA Unggulan Zainul Hasan Genggong', NULL, 'Sekolah', NULL, 'http://gok.com', NULL),
(15, 'MA Model Zainul Hasan Genggong', NULL, 'Sekolah', NULL, 'http://gik.co.id', NULL),
(16, 'STIH Zainul Hasan ', NULL, 'Universitas', NULL, 'http://kol.com', NULL),
(17, 'IAI Zainul Hasan Genggong', NULL, 'Universitas', NULL, 'http://kol.com', NULL),
(18, 'AKPER Zainul Hasan Genggong', NULL, 'Universitas', NULL, 'http://ap.co', NULL),
(19, 'AKBID Zainul Hasan Genggong', NULL, 'Universitas', NULL, 'http://lop.com', NULL),
(20, 'STIKES Zainul Hasan Genggong', NULL, 'Universitas', NULL, 'http://molk.com', NULL);
...
CREATE TABLE IF NOT EXISTS `pengumuman` (
  ...
  `judul_pengumuman` varchar(160) DEFAULT NULL,
  `isi_berita` text,
...
INSERT INTO `pengumuman` (`id_pengumuman`, `judul_pengumuman`, `isi_berita`, `tanggal_publish`, `id_kategori`, `id_user`, `nkat2`, `seo_url`) VALUES
(1, 'Pengumuman Ini Adalah Percobaan Saja Oke Brohh... :D', 'CodeIgniter is an Application Development Framework - a toolkit - for people who build web sites using PHP. Its goal is to enable you to develop projects much faster than you could if you were writing code from scratch, by providing a rich set of libraries for commonly needed tasks, as well as a simple interface and logical structure to access these libraries. CodeIgniter lets you creatively focus on your project by minimizing the amount of code needed for a given task.', '2014-06-05', 3, 20140001, 'Santri Baru', NULL),
(2, 'Passing Data to your Calendar Cells', 'To add data to your calendar cells involves creating an associative array in which the keys correspond to the days you wish to populate and the array value contains the data. The array is passed to the third parameter of the calendar generating function. Consider this example:', '2014-06-04', 2, 20140001, 'SMA Unggulan', NULL),
(3, 'CodeIgniter is an Application Development Framework', 'CodeIgniter is an Application Development Framework', '2014-06-04', 1, 20140001, 'SMK Zainul Hasan', NULL),
(4, 'dfCodeIgniter is an Application Development Framework', 'CodeIgniter is an Application Development Frameworkasas asdasd', '2014-06-02', 2, 20140001, 'MA Zainul Hasan', NULL),
(5, 'Ini Adalah Pengumuman Kategori Santri Baru', '<p>Pengumuman di SINI menggunakan Modul <strong>CK Editor Lhoo...</strong></p>\r\n\r\n<ol>\r\n	<li><strong><em>Pesantren Zainul Hasan Genggong, Gitu Lhoo....</em></strong></li>\r\n	<li>test</li>\r\n</ol>\r\n', '2014-07-02', 3, 20140001, 'Santri Baru', NULL);
...
CREATE TABLE IF NOT EXISTS `perizinan` (
  `id_perizinan` int(5) NOT NULL AUTO_INCREMENT,
  `id_santri` int(8) DEFAULT NULL,
  `id_user` int(8) DEFAULT NULL,
  `jenis_ijin` varchar(30) DEFAULT NULL,
  `alasan_ijin` text,
  `waktu_pergi` datetime DEFAULT NULL,
  `waktu_datang` datetime DEFAULT NULL,
  `keterangan` text,
  `wali` varchar(30) DEFAULT NULL,
  `kontak_wali` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`id_perizinan`),
  KEY `FK_p_santri` (`id_santri`),
  KEY `FK_p_user` (`id_user`)
...
INSERT INTO `perizinan` (`id_perizinan`, `id_santri`, `id_user`, `jenis_ijin`, `alasan_ijin`, `waktu_pergi`, `waktu_datang`, `keterangan`, `wali`, `kontak_wali`) VALUES
(8, 5, 20140001, 'izin pulang', 'Pernikahan Kakak', '2014-07-13 07:00:00', '2014-07-15 07:00:00', '-', 'Ahmad Fathonah', '0816172323');

-- --------------------------------------------------------

--
-- Struktur dari tabel `priode_daftar`
--

CREATE TABLE IF NOT EXISTS `priode_daftar` (
  `id_priode` int(4) NOT NULL AUTO_INCREMENT,
  `nama_priode` varchar(50) DEFAULT NULL,
  ...
  PRIMARY KEY (`id_priode`),
  KEY `FK_lembaga` (`id_lembaga`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `santri` (
  `id_santri` int(8) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `santri` (`id_santri`, `nama_lengkap`, `nama_panggilan`, `tempat_lahir`, `tanggal_lahir`, `kelamin`, `catatan_kesehatan`, `warga_negara`, `alamat`, `provinsi`, `kabupaten`, `kecamatan`, `kode_pos`, `pendidikan_terakhir`, `tahun_lulus`, `sekolah_asal`, `alamat_sekolah`, `nama_wali`, `pekerjaan_wali`, `kontak_wali`, `alamat_wali`, `no_identitas`, `nama_ibu`, `pekerjaan_ibu`, `kontak_ibu`, `alamat_ibu`, `email`, `password`, `pondok`, `updated`, `id_sekolah`, `id_walisantri`, `id_TA`) VALUES
(5, 'rr', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `santri_baru` (
  `id_santri_baru` int(8) NOT NULL AUTO_INCREMENT,
  `nama_lengkap` varchar(30) DEFAULT NULL,
  `nama_panggilan` varchar(30) DEFAULT NULL,
  `tempat_lahir` varchar(30) DEFAULT NULL,
  `tanggal_lahir` date DEFAULT NULL,
  ...
  `email` varchar(30) DEFAULT NULL,
  `password` varchar(30) DEFAULT NULL,
  `dokumen_lengkap` enum('Lengkap','Tidak Lengkap') DEFAULT 'Tidak Lengkap',
  `pembayaran` enum('Tidak Lunas','Lunas') DEFAULT 'Tidak Lunas',
  `Catatan` text,
  ...
  `id_priode` int(4) DEFAULT NULL,
  `id_ta` int(4) DEFAULT NULL,
  PRIMARY KEY (`id_santri_baru`),
  KEY `FK_sb_user` (`id_user`),
  KEY `FK_sb_sekolah` (`id_sekolah`),
  KEY `FK_sb_priode` (`id_priode`),
  KEY `FK_sb_ta` (`id_ta`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=21 ;

--
-- Dumping data untuk tabel `santri_baru`
--

INSERT INTO `santri_baru` (`id_santri_baru`, `nama_lengkap`, `nama_panggilan`, `tempat_lahir`, `tanggal_lahir`, `kelamin`, `catatan_kesehatan`, `warga_negara`, `alamat`, `propinsi`, `kabupaten`, `kecamatan`, `kode_pos`, `pendidikan_terakhir`, `tahun_lulus`, `sekolah_asal`, `alamat_sekolah`, `nama_wali`, `pekerjaan_wali`, `kontak_wali`, `alamat_wali`, `no_identitas`, `nama_ibu`, `pekerjaan_ibu`, `kontak_ibu`, `alamat_ibu`, `email`, `password`, `dokumen_lengkap`, `pembayaran`, `Catatan`, `last_change`, `id_user`, `id_sekolah`, `id_priode`, `id_ta`) VALUES
(1, 'Rio Bahtiar', 'Rio', 'Bondowoso', '1990-01-31', 'Pria', 'Sehat', 'Indonesia', 'Jl. Gunung Rau, Sleman DIY, Jogja', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Tidak Lengkap', 'Tidak Lunas', NULL, '0000-00-00 00:00:00', NULL, NULL, NULL, NULL),
(2, 'Test', 'testoo', 'Jember', '2014-07-15', 'Wanita', 'Sehattt', 'Asing', 'Surga', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Tidak Lengkap', 'Tidak Lunas', NULL, '0000-00-00 00:00:00', NULL, NULL, NULL, NULL),
(3, 'lagi test', 'tesssoo', 'Bangil', '2014-07-01', 'Pria', 'Alhamdulillah yaaa', 'Indonesia', 'Astaga Mana yaa', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Tidak Lengkap', 'Tidak Lunas', NULL, '0000-00-00 00:00:00', NULL, NULL, NULL, NULL),
(4, 'Alfian Syahputra', 'Fian', 'Bondowoso', '1991-08-21', 'Pria', 'Sehat', 'Indonesia', 'Jl. Raya', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Tidak Lengkap', 'Tidak Lunas', NULL, '0000-00-00 00:00:00', NULL, NULL, NULL, NULL),
(5, 'khoiruddin', 'Khoiruddin', NULL, NULL, 'Wanita', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Tidak Lengkap', 'Tidak Lunas', NULL, '0000-00-00 00:00:00', NULL, NULL, NULL, NULL),
(6, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00 00:00:00', NULL, NULL, NULL, NULL),
(12, 'mok mokk', 'sdfsdfdsfdsfsd', '', '0000-00-00', 'Pria', '', 'WNI', '', '0', '0', '0', '', 'WNI', '', 'dfdfd', '', '', '', '', '', '0', '', '', '', '', '', '0', '', '', '0', '0000-00-00 00:00:00', 0, 0, 0, 0),
(13, 'xcx', 'xcxc', 'xcx', '0000-00-00', 'Pria', 'xcxc', 'WNA', '', '0', '0', '0', '45654', 'WNA', '', 'xcx', '', 'xc', '', '', '', '0', '', '', '', '', '', '0', '', '', '0', '0000-00-00 00:00:00', 0, 0, 0, 0),
(14, 'Dolde', 'Moaa', '', '1992-12-12', 'Pria', '', 'WNI', '', '0', '0', '0', '', 'WNI', '', '', '', 'asas', '', '56456456', '', '0', '', '', '', '', '', '0', '', '', '0', '0000-00-00 00:00:00', 0, 0, 0, 0),
(15, 'Muhammad Hamdan', 'Hamdan', 'Jember', '2006-09-08', 'Wanita', 'KOkok', 'WNA', 'Jl. Gungu, Gungung, Mama', '0', '0', '0', '90909', 'WNA', '2012', 'SMK Jaya', 'Jl. Trucuk', 'Beo', 'Pengusaha', '09232788323', 'jl. Nusa Kambangan', '0', 'Azzahra', 'Guru', '089212322323', 'Wali  wakian kokokmmmmm', 'code@fok.com', '0', '', '', '0', '0000-00-00 00:00:00', 0, 0, 0, 0),
(16, '', '', '', '0000-00-00', 'Pria', '', 'WNI', '', '0', '0', '0', '', 'WNI', '', '', '', '', '', '', '', '0', '', '', '', '', '', '0', '', '', '0', '0000-00-00 00:00:00', 0, 0, 0, 0),
(17, '', '', '', '0000-00-00', 'Pria', '', 'WNI', '', '0', '0', '0', '', 'WNI', '', '', '', '', '', '', '', '0', '', '', '', '', '', '0', '', '', '0', '0000-00-00 00:00:00', 0, 0, 0, 0),
(18, '', '', '', '0000-00-00', 'Pria', '', 'WNI', '', '0', '0', '0', '', 'WNI', '', '', '', '', '', '', '', '0', '', '', '', '', '', '0', '', '', '0', '0000-00-00 00:00:00', 0, 0, 0, 0),
(19, '1 Algebra KO', '2 Algebra K', '3 jklss', '1985-11-11', 'Pria', '5 Algebra KOx', 'WNI', '7 Algebra KOAlgebra KO', '0', '3511', '3511061', '11287', 'WNA', '2013', '14lgebra KO j', '15Algebra KO l', '16Algebra KO b', '17Algebra KO f', '18Algebra KO er', '19Algebra KO q', '0', '20Algebra KO', '21Algebra KO', '22Algebra KO', '23Algebra KO', '24Algebra KO@', '0', '', '', '0', '0000-00-00 00:00:00', 0, 0, 0, 0),
(20, '12dfgdf', '234gdfg', 'dfgdfh', '1986-04-21', 'Pria', 'sdfsdf', 'WNA', 'sdfsdf', '21', '2105', '2105040', '345345', 'WNA', 'cvb', 'gfh', 'fghfg', 'fghfgh', 'gh', 'fgh', 'fgh', '0', 'rrr', 'ggggg', 'cvbcvb', 'ggggggggggggggggggggggggggggggggggggggggg', '3GFG', '0', '', '', '0', '2014-08-05 10:11:10', 0, 0, 0, 0);
...
CREATE TABLE IF NOT EXISTS `tahun_ajaran` (
  `id_ta` int(4) NOT NULL AUTO_INCREMENT,
  `nama_ta` varchar(4) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `kelamin` enum('Pria','Wanita') DEFAULT NULL,
  `alamat_sekarang` varchar(160) DEFAULT NULL,
  `alamat_asal` varchar(160) DEFAULT NULL,
  `pernikahan` enum('Belum Menikah','Menikah') DEFAULT NULL,
  ...
  `id_santri` int(8) DEFAULT NULL,
  PRIMARY KEY (`id_user`),
  KEY `FK_Wali_santri_idSantri` (`id_santri`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=20140003 ;

--
-- Dumping data untuk tabel `user`
--

INSERT INTO `user` (`id_user`, `nama_lengkap`, `tempat_lahir`, `tgl_lahir`, `kelamin`, `alamat_sekarang`, `alamat_asal`, `pernikahan`, `institusi`, `jabatan`, `no_identitas`, `no_hp`, `email`, `level`, `password`, `updated`, `id_santri`) VALUES
(20140001, 'Rio Bahtiar', 'Bondowoso', '1991-08-21', 'Pria', 'Condong Catur, Sleman, DIY', 'Sumber Wringin, Bondowoso', 'Belum Menikah', 'CodeLabs', 'CEO', '908765123677123', '081515933306', 'akhibahtiar@gmail.com', '1', '210891', NULL, NULL),
(20140002, 'Fadlurrahman', 'Sumenep', '1990-03-11', 'Pria', 'Jl. Ngeringin Condong Catur Sleman DIY', 'Sumber Bentong, Bluto, Sumenep', 'Menikah', NULL, NULL, NULL, NULL, 'fadlur@gmail.com', '2', '827ccb0eea8a706c4c34a16891f84e', NULL, NULL);
...
--
-- Ketidakleluasaan untuk tabel `detail_pelanggaran`
--
ALTER TABLE `detail_pelanggaran`
  ADD CONSTRAINT `FK_pelanggaran` FOREIGN KEY (`id_pelanggaran`) REFERENCES `daftar_pelanggaran` (`id_pelanggaran`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_petugas` FOREIGN KEY (`id_petugas`) REFERENCES `user` (`id_user`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_santri` FOREIGN KEY (`id_santri`) REFERENCES `santri` (`id_santri`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `halaman`
--
ALTER TABLE `halaman`
  ADD CONSTRAINT `FK_Halaman_User` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `kabupaten`
--
ALTER TABLE `kabupaten`
  ADD CONSTRAINT `FK_propinsi` FOREIGN KEY (`id_propinsi`) REFERENCES `propinsi` (`id_propinsi`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `kecamatan`
--
ALTER TABLE `kecamatan`
  ADD CONSTRAINT `FK_kabupaten` FOREIGN KEY (`id_kabupaten`) REFERENCES `kabupaten` (`id_kabupaten`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `konfirmasi_bayar`
--
ALTER TABLE `konfirmasi_bayar`
  ADD CONSTRAINT `fk_sb_konfirmasi` FOREIGN KEY (`id_santri_baru`) REFERENCES `santri_baru` (`id_santri_baru`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_user_konfirmasi` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `lembaga_pendidikan`
--
ALTER TABLE `lembaga_pendidikan`
  ADD CONSTRAINT `FK_priode` FOREIGN KEY (`id_priode`) REFERENCES `priode_daftar` (`id_priode`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `pengumuman`
--
ALTER TABLE `pengumuman`
  ADD CONSTRAINT `fk_kat` FOREIGN KEY (`id_kategori`) REFERENCES `kategori` (`id_kategori`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
ALTER TABLE `perizinan`
  ADD CONSTRAINT `FK_p_santri` FOREIGN KEY (`id_santri`) REFERENCES `santri` (`id_santri`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_p_user` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `priode_daftar`
--
ALTER TABLE `priode_daftar`
  ADD CONSTRAINT `FK_lembaga` FOREIGN KEY (`id_lembaga`) REFERENCES `lembaga_pendidikan` (`id_pendidikan`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `santri`
--
ALTER TABLE `santri`
  ADD CONSTRAINT `FK_sekolah` FOREIGN KEY (`id_sekolah`) REFERENCES `lembaga_pendidikan` (`id_pendidikan`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_ta` FOREIGN KEY (`id_TA`) REFERENCES `tahun_ajaran` (`id_ta`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_walisantri` FOREIGN KEY (`id_walisantri`) REFERENCES `user` (`id_user`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `FK_Wali_santri_idSantri` FOREIGN KEY (`id_santri`) REFERENCES `santri` (`id_santri`) ON DELETE NO ACTION ON UPDATE CASCADE;
