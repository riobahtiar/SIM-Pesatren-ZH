...
<div class="panel-heading" id="border-orange-bawah"><i class="fa fa-star fa-spin" ><a href="/localhost"></a> </i> &nbsp;&nbsp;<b>Pengumuman Terbaru </b><span class="pull-right"><b><i class="fa fa-folder"></i> Arsip</b></span></div>
  <div class="panel-body">
    ...
    <div class="bs-callout bs-callout-info">
      <h4><a href="<?php $linksp=$hm->judul_pengumuman; echo "info/".url_title($linksp).".html";?>"><?php echo $hm->judul_pengumuman;?></a></h4>
            <h5><span class="label label-pengumuman"><span class="fa fa-bookmark-o"></span>  Kategori </span><span class="label label-pengumuman-samping"><?php echo $hm->kategori;?></span></h5>
    </div>
    <?php endforeach; ?>  
