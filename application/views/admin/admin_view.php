...
<script type="text/javascript" src="<?php echo base_url();?>asseta/ckeditor/ckeditor.js"></script>
...
<script type="text/javascript" src="<?php echo base_url();?>asseta/ckeditor/dashboard.js"></script>
